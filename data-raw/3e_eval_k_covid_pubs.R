...
MAX_PARALLEL_CORES <- 4 #set this to a reasonable number based on the server spec

# setup some variables controlling the runs and outputs
base_result_label <- "preprints_covid_var2"

seed_heldout <- 9868467
seed_stm <- 7648689
...
pubs_covid_models_var2 <- K_values %>%
...
pubs_covid_metrics_var2 <- pubs_covid_models_var2 %>%
