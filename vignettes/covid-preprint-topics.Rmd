...
* stm plot function (high res)

```{r echo=TRUE, dpi = 150}
plot(covid_model_K20, n = 5)
```

* alternatively we can extract the topic proportions from the beta matrix


## Understanding and labeling topics

* stm summary function

```{r echo=TRUE, class.output="scroll-100"}
summary(covid_model_K20)
```

* we can extract these word probabilities (explain Prob and frex) and create word clouds for an interpretation


## Covariate effects

* illustrate with both STM plot methods and stminsight package
